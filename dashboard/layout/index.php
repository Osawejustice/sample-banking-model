        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="float-right">
                    <a href="javascript:" class="btn btn-sm btn-primary">Quick Transfer</a>
                    <a href="./support?modal=true" class="btn btn-sm btn-dark lazy">Open Ticket</a>
                    <a href="./profile" class="btn btn-sm btn-success lazy">Profile</a>
                    <!-- /.btn btn-sm -->
                </div>
                <!-- /.float-right -->
            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="media">
                                    <div class="media-body overflow-hidden">
                                        <p class="text-truncate font-size-14 mb-2">Account Balance</p>
                                        <h4 class="mb-0"><?=$naira.$app->format($user->balance)?></h4>
                                    </div>
                            ...
                            <div class="card-body border-top py-3">
                                <div class="text-truncate text-right">
                                    <a href="./wallet" class="lazy">View More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="media">
                                    <div class="media-body overflow-hidden">
                                        <p class="text-truncate font-size-14 mb-2">Ledger Balance</p>
                                        <h4 class="mb-0"><?=$naira.$app->format($user->balance)?></h4>
                                    </div>
                                    <div class="text-primary">
                                        <i class="ri-wallet-2-line font-size-24"></i>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="media">
                                    <div class="media-body overflow-hidden">
                                        <p class="text-truncate font-size-14 mb-2">Loan Status</p>
                            ...
                            <div class="card-body border-top py-3">
                                <div class="text-truncate text-right">
                                    <a href="./transactions" class="lazy">View More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="media">
                                    <div class="media-body overflow-hidden">
                                        <p class="text-truncate font-size-14 mb-2">Transfer Mode</p>
                                        <h4 class="mb-0"></h4>
                                    </div>
                                    <div class="text-primary">
                                        <i class="ri-list-check-2 font-size-24"></i>
            ...
            <div class="col-xl-4">
                <div class="card border border-primary">
                    <div class="card-header bg-transparent border-primary">
                        <h5 class="my-0 text-primary"><i class="mdi mdi-bullseye-arrow mr-3"></i>Info</h5>
                    </div>
                    <div class="card-body pt-0">
                        <h6 class="h6">Account Number</h6>
                        <p class="mb-2 card-text">08157752281 <a href="javascript:"><i class="ri-file-copy-line"></i></a></p>

                        <h6 class="h6">Security Tip</h6>
                        <p class="card-text">Change your Internet banking Password Frequently to keep your Account Safe</p>
                    </div>
                </div>
